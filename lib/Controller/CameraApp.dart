...
import 'package:trimmz/CameraShutterButton.dart';
...
import 'package:trimmz/lru_map.dart';


class CameraApp extends StatefulWidget {
  final List<CameraDescription> cameras;
  final int uploadType;
  CameraApp({Key key, @required this.uploadType, @required this.cameras}) : super (key: key);
  @override
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      takenPhoto == '' ? CameraShutterButton(
                        strokeWidth: 5,
                        radius: 50,
