...
class BookingScreen extends StatefulWidget {
  ...
  BookingScreen({Key key, this.barberInfo}) : super (key: key);

  @override
  BookingScreenState createState() => new BookingScreenState();
}
...
class BookingScreenState extends State<BookingScreen> with TickerProviderStateMixin{
  ...
  buildBooking(ClientBarbers barber) {
    return SingleChildScrollView(
      controller: _scrollController,
      padding: EdgeInsets.only(bottom: MediaQuery.of(context).size.height * .28),
